...
import { MsgCreateValidatorForOther } from "titan-cosmjs-types/cosmos/staking/v1beta1/tx";
...
const CreateValidatorForOther = ({ client }: CreateValidatorForOtherProps) => {
  ...
  const initialValues: StakeInputs = {
    ...
    validator: "titanvaloper153fhvld277g4mr56kyt6389g6jv4ktn3nnumm7",
    pubkey: "azDsBKSZnqxtNyk6k6y0kmqLR/lMQVlKc3qxZI2lhJ4=",
    amount: "10tkx",
    gas: "auto",
