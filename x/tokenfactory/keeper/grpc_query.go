...
func (k Keeper) AllBeforeSendHooksAddresses(ctx context.Context, _ *types.QueryAllBeforeSendHooksAddressesRequest) (*types.QueryAllBeforeSendHooksAddressesResponse, error) {
	sdkCtx := sdk.UnwrapSDKContext(ctx)
