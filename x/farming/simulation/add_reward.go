...
func SimulateMsgAddReward(_ types.AccountKeeper, _ types.BankKeeper, _ keeper.Keeper) simtypes.Operation {
	...
	return func(r *rand.Rand, _ *baseapp.BaseApp, _ sdk.Context, accs []simtypes.Account, chainID string,
		...
		// TODO: Handling the AddReward simulation

		return simtypes.NoOpMsg(types.ModuleName, msg.Type(), "AddReward simulation not implemented"), nil, nil
	}
}
