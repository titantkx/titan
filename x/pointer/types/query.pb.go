...
func _Query_Erc20Native_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(QueryServer).Erc20Native(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _Query_Erc20NativeAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(QueryServer).Erc20NativeAll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Erc20Native",
			Handler:    _Query_Erc20Native_Handler,
		},
		{
			MethodName: "Erc20NativeAll",
			Handler:    _Query_Erc20NativeAll_Handler,
		},
	},
...
func (m *QueryErc20NativeResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.Erc20Native.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *QueryErc20NativeAllResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Erc20Native) > 0 {
		for iNdEx := len(m.Erc20Native) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Erc20Native[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryErc20NativeResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Erc20Native", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.Erc20Native.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *QueryErc20NativeAllResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Erc20Native = append(m.Erc20Native, Erc20Native{})
			if err := m.Erc20Native[len(m.Erc20Native)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
