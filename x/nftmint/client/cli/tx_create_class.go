...
func CmdCreateClass() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "create-class [uri] [uri-hash] --class-name [name] --class-symbol [symbol] --class-description [description] --class-data [data] --from [creator] [flags]",
		Short: "Create new class to mint NFTs",
